...
const experienceItems = [
  {
    ...
    highlights: [
      '3x revenue growth and expanded to multiple locations',
      'Established company culture and values that attract mission-driven talent',
      'Developed comprehensive brand strategy and visual identity',
      'Managed teams across operations, marketing, and community impact',
      'Implemented systems and processes for organizational scalability',
      'Led strategic initiatives around social enterprise model refinement',
    ],
    skills: ['Leadership', 'Operations', 'Strategy', 'Brand Building', 'Team Management', 'Culture Building'],
  },
  {
    ...
    highlights: [
      'Built custom web applications using React and Next.js',
      'Implemented responsive design with focus on accessibility',
      'Collaborated with brands on digital strategy and transformation',
      'Mentored junior developers on web development best practices',
      'Average project delivery on time with client satisfaction >95%',
      'Specialized in projects serving social enterprises and nonprofits',
    ],
    skills: ['React', 'Next.js', 'Web Design', 'UX/UI', 'JavaScript', 'TypeScript', 'Tailwind CSS'],
  },
  {
