...
Two weeks ago I sat down with a [10-day sprint plan](/dispatch/10-day-portfolio-sprint-plan) and built three portfolio mockups in five days. A [salon site](/dispatch/building-salon-landing-page-nextjs). A [headless Shopify storefront](/dispatch/headless-shopify-storefront-nextjs). A [full-stack dashboard with Supabase auth](/dispatch/full-stack-dashboard-supabase-nextjs). All deployed. All documented. Portfolio done.
...
This is the real-world example I was working toward when I [started the sprint](/dispatch/10-day-portfolio-sprint-plan). The mockups proved velocity. Coffee for Peace proves judgment. If you want a headless WordPress site built with this stack — [get in touch](https://byronpantoja.com/contact).
