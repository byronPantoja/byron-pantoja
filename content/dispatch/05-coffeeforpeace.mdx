...
This is the real-world example I was working toward when I [started the sprint](/dispatch/01-sprint-plan). The mockups proved velocity. Coffee for Peace proves judgment. If you want a headless WordPress site built with this stack — [get in touch](https://byronpantoja.com/contact).

---

*This post is part of a series on building a web developer portfolio with AI-assisted development: [The Plan](/dispatch/01-sprint-plan) · [Salon Site](/dispatch/02-salon-project) · [Shopify Storefront](/dispatch/03-shopify-store) · [Dashboard + Portfolio](/dispatch/04-dashboard-project)*
